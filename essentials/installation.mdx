...
![](https://github.com/Rexshack-RedM/rsg-docs/blob/main/images/heidi-step.png)

**Press new to create a session**

![](https://github.com/Rexshack-RedM/rsg-docs/blob/main/images/heidi-step2.png)
...
Once this is complete, we recommend visiting [Setting Permissions](https://rsg.mintlify.app/quickstart) to configure your **server.cfg** with any players you'd like to give elevated permissions!